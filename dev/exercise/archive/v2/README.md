...
│   ├── 1_exercise_library.py      # Exercise management
│   ├── 2_create_workout.py        # Workout template creation
│   ├── 3_workout_overview.py      # Workout selection
│   ├── 4_workout_execution.py     # Active workout tracking
│   └── 5_history.py               # Historical data and analytics
